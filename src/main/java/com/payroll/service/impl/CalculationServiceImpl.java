    ...
    public List<PaymentResult> calculatePayroll(
        ...
        for (Payment payment : payments) {
            ...
            for (Employee employee : employees) {
                ...
                int overtimeHours = overtimeService.getOvertimeHours(overtimesByEmployeeAndMonth, employeeId, paymentPeriodKey);

                // Base pay calculation
                double basePay = basePayService.calculateBasePay(employee, rate, payment, taxClass,calendar);
